...
<div class=" mb-3 col-10 mx-auto shadow border border-warning rounded-4 d-flex flex-column align-items-center " style="overflow-y: hidden; align-items: center;  "> 
    <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d2522.018335495536!2d4.316595976095268!3d50.79376877165978!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sEFP!5e0!3m2!1sfr!2sbe!4v1738833349900!5m2!1sfr!2sbe" width="360" height="auto" style="border:-4 ;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="  mx-auto" ></iframe>
</div>
   ...
   <!-- <p>Remplissez le formulaire ci-dessous pour nous contacter.</p>-->
    <form class="col-11 mx-auto border-light " action="/" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control rounded-4" style="border-color:#00c3de;"  id="email" name="email" placeholder="Adresse mail" required>
        </div>
        ...
        <div class="mb-3">
            <textarea class="form-control rounded-4 " style="border-color:#00c3de;" id="message" name="message" rows="4" placeholder="Message..." required></textarea>
        </div>
...
<?php /**PATH /home/coline/REPOS PERSO/Hackathon-TrouveTonStage/resources/views/contact-form.blade.php ENDPATH**/ ?>