...
<div class="hstack ps-2 ">
    <img class="pe-4"  src="{{asset('/arrow_back_ios.png')}}" alt="fleche jaune">
...
<div class="container">
    ...
    <form class="col-11 mx-auto border-light " action="/envoi" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 hstack gap-2 rounded-5 d-flex">
        ...
        <div class="wstack"> 
            <input type="file" id="fileInput" class="w-100 mb-3 ">
    ...
    <div class=" col-11 mx-auto container border border-warning p-3 rounded-4 mb-3">
        <div class="hstack">
            <img class="ps-3 w-25" src="{{asset('/Ellipse 1.png')}}" alt="icon photo profil">
            <div class=" mx-auto text-center">
                <p class="fw-bold m-1">Raphaele Galmisch</p>
    ...
    <div class=" col-11 mx-auto border border-warning p-3 rounded-4 mb-3">
        <div class="hstack">
            <img  class="ps-3 w-25" src="{{asset('/Ellipse 1.png')}}" alt="icon photo profil">
            <div class="mx-auto text-center">
                <p class="fw-bold m-1">Valérie Vandewalle</p>
    ...
    <div class=" col-11 mx-auto border border-warning p-3 rounded-4 mb-3">
        <div class="hstack">
            <img  class="ps-3 w-25" src="{{asset('/Ellipse 1.png')}}" alt="icon photo profil">
            <div class="mx-auto text-center">
                <p class="fw-bold m-1">Floriane Perrot</p>
    ...
    <div class=" col-11 mx-auto border border-warning p-3 rounded-4 mb-3">
        <div class="hstack">
            <img  class="ps-3 w-25" src="{{asset('/Ellipse 1.png')}}" alt="icon photo profil">
            <div class="mx-auto text-center">
                <p class="fw-bold m-1">Juan Pacifico Y Sanchez</p>
